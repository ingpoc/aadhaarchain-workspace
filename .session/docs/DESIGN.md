...
- Verification evidence: [`../../.agents/skills/testing-ledger/SKILL.md`](../../.agents/skills/testing-ledger/SKILL.md)
...
Design acceptance is recorded by the testing-ledger owner. This document does
not promote screenshots or historical captures into current product status.
...
evidence live in `.agents/skills/testing-ledger/SKILL.md`.
...
- **Dependencies and acceptance:** Buyer scope is owned by `ondcbuyer/GOAL.md`;
  ...
  evidence from `.agents/skills/testing-ledger/SKILL.md`. Multi-seller production behavior remains a CF2
...
- **Dependencies and acceptance:** Authority and commerce contracts are owned by
  ...
  `.agents/skills/testing-ledger/SKILL.md`. Acceptance requires one verified in-limit purchase, one exact
...
- **Dependencies and acceptance:** Order/issue ownership lives in
  ...
  `.agents/skills/testing-ledger/SKILL.md`. Production cancellation, return, refund, and grievance depth
...
- **Dependencies and acceptance:** Seller outcomes live in `ondcseller/GOAL.md`;
  ...
  keyboard, responsive, and live-capture gates live in `.agents/skills/testing-ledger/SKILL.md`. Complete
...
- **Dependencies and acceptance:** Decision, approval, authentication, privacy,
  ...
  notification, and accessibility evidence lives in `.agents/skills/testing-ledger/SKILL.md`. Web evidence
...
- **Dependencies and acceptance:** Agent/mandate/tool ownership lives in
  ...
  the testing-ledger owner. Web captures do not prove Buyer voice or iOS.
...
`.agents/skills/testing-ledger/SKILL.md` owns the executable gates and evidence ledger. Mockups and
