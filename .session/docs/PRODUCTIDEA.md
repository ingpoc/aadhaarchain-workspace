...
Production participation requires onboarding, registry subscription, protocol
signing and verification, asynchronous Beckn request/callback handling,
conformance, payment and settlement, logistics, and issue workflows.
`ARCHITECTURE.md` owns those requirements; `../checklist/checklist.json` alone owns
...
Build: [`IMPLEMENTATIONPLAN.md`](IMPLEMENTATIONPLAN.md). Verify:
[`../../.agents/skills/testing-ledger/SKILL.md`](../../.agents/skills/testing-ledger/SKILL.md).
Architecture: [`ARCHITECTURE.md`](ARCHITECTURE.md). App outcomes:
`../../ondcbuyer/GOAL.md`, `../../ondcseller/GOAL.md`.
